...
export const metadata = {
  ...
  description:
    "Predict the future. Predict a H1. Wamplify is a UniMelb WAM calculator and subject score calculator for the University of Melbourne by Risa & Ben. It works on all standard Unimelb subjects.",
